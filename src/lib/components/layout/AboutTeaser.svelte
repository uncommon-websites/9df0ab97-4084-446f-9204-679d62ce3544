...
<script lang="ts">
	...
	name: "Alan Cowen",
	role: "Founder & CEO",
	image: "/generated/image-a-friendly-tech-founder-in-a-modern-offi.webp"
};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`“Our goal is to build AI that doesn’t just replicate human speech, but understands how it feels to be understood.”`}
			/>
